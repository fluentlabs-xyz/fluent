use reth_chainspec::{
    ChainSpec, DEV, DEVELOPER_PREVIEW, FLUENT_TESTNET, HOLESKY, HOODI, MAINNET, SEPOLIA,
};
...
pub const SUPPORTED_CHAINS: &[&str] =
    &["mainnet", "sepolia", "holesky", "hoodi", "dev", "developer-preview", "testnet"];
